...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://api.mateandmentors.com/mateandmentors/contacts/create', {
        method: 'POST',
        headers: {
  ...
  const contactInfo = [
    ...
    { icon: <FaEnvelope />, title: "Email", info: "support@mateandmentors.info", desc: "Send us anytime!", color: "from-purple-500 to-purple-600" },
    ...
    <Layout activePage="Contact">
      ...
      <section className="bg-purple-100 py-5 px-4">
        <div className="container mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-2">Get In Touch</h1>
